app.controller("MainController", ['$scope', 'RestApiService', function($scope, RestApiService){

  var createChart = function(treeData) {
  ...
  RestApiService.get("http://localhost:3000/users").success(function(users){
      createChart(users);
  });
